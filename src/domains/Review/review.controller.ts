...
const submitPublic = asyncHandler(async (req: Request, res: Response) => ok(res, await reviewService.submitPublicReview(req.params.token, req.body.rating, req.body.comment), "Thank you for your feedback"));
...
export default { getPublic, submitPublic, listAdmin, resend };
